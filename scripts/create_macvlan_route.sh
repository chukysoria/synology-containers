...
# Set address of the host to 10.174.1.48/32
ip addr add 10.174.1.48/32 dev macvlan0
# Up internface
ip link set macvlan0 up
# Add the route for range 10.174.1.48/28
ip route add 10.174.1.48/28 dev macvlan0
